...
namespace Project
{
    public static class Controller
    {
        ...
        private static string _mainMenu =
            ...
            "***** 5 - Check inventory ************************\n" +
            "**************************************************";
        private static string _employeesMenu =
            ...
            "***** 5 - Go back ********************************\n" +
            "**************************************************";
        private static string _customersMenu =
            ...
            "***** 5 - Go back ********************************\n" +
            "**************************************************";
        private static string _productsMenu =
            "***** 1 - List all books *************************\n" +
            ...
            "***** 7 - Go back ********************************\n" +
            "**************************************************";
        private static string _promotionSubMenu =
            "***** 1 - Add promotion to a book ****************\n" +
            "***** 2 - Add promotion to accessory *************\n" +
            "**************************************************";
        private static string _persistenceMenu =
            "***** 1 - Serialize data *************************\n" +
            "***** 2 - Deserialize data ***********************\n" +
            "***** 3 - Go back ********************************\n" +
            "**************************************************";
        private static string _serializeSubMenu =
            "***** 1 - Employees ******************************\n" +
            "***** 2 - Customers ******************************\n" +
            "***** 3 - Products *******************************\n" +
            "**************************************************";
            ...
            switch (option)
            {
                ...
                case 2:
                    ...
                    if (isRetired)
                    {
                        ...
                        int retire = Int32.Parse(inputRetire);
                        switch (retire)
                        {
                            case 1:
        ...
        public static void HandleProductsMenu()
        {
            ...
            switch (option)
            {
                case 1:
                    ...
                    break;
                case 2:
                    foreach (var a in Accessory.Accessories)
                    {
        ...
        public static void HandlePromotionSubMenu()
        {
            ...
            switch (option)
            {
                ...
                case 2:
                    ...
                    Accessory accessory = Accessory.Accessories[idOptionAcc];
        ...
        public static void HandleSerializeSubMenu()
        {
            ...
            {
                case 1:
                    SerializeDeserialize.SerializeToFile(Employee.Employees, "employees.json");
                    break;
                case 2:
                ...
                case 3:
                    ...
                    foreach (var book in Book.Books)
                        products.Add(book);
                    foreach (var acc in Accessory.Accessories)
                        products.Add(acc);
                    SerializeDeserialize.SerializeToFile(products, "products.json");
                    break;
            }
        }
        ...
        public static void HandleDeSerializeSubMenu()
        {
            ...
            {
                case 1:
                    List<Employee> employees = SerializeDeserialize.DeserializeFromFile<Employee>("employees.json");
                ...
                case 2:
                    ...
                    break;
                case 3:
                    List<Product> products = SerializeDeserialize.DeserializeFromFile<Product>("products.json");
